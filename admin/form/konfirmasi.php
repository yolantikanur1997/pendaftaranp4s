        ...
        <div class="modal-dialog">
          ...
          <div class="col-sm-12">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
              <label>Status</label>
              <select class="theSelect form-control" id="status" name="status" required="required" style="width: 100%;"> 
                <option value="">Pilih</option>
                <option value="Sedang di Proses">Sedang di Proses</option>
                <option value="Konfirmasi Pembayaran Berhasil">Konfirmasi Pembayaran Berhasil</option>
                <option value="Pembayaran Belum di Terima">Pembayaran Belum di Terima</option>
              </select>
              </div>
                </div>
                <div class="col-sm-12">
              <div class="form-group">
              <label>Bank</label>
              <textarea class="form-control" id="catatan" name="catatan" required="required"> </textarea>
              </div>
                </div>
