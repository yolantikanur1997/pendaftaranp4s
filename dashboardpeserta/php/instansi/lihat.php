...
$stmt = $koneksi->prepare("SELECT id,nama_instansi,kategori,telepon,alamat,tanggal_registrasi,username,password FROM registrasi_akun_instansi WHERE id=" . $_SESSION['id']);
