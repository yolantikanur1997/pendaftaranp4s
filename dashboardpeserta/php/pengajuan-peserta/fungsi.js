    ...
    function tambah(e)
    {
        ...
        $.ajax({
            ...
            keterangan: $('#keterangan').val(), data: table_data
        },
                    ...
                    "aoColumns": [
                     {
                        ...
                        {"sTitle": "Catatan","mData": "catatan"},
                        {
                            "sTitle":"Opsi",
                            "mData": "id",
                            "render": function(mData, type, row, meta){
                                return'<button class="btn btn-xs btn-default" title="Pilih" onclick="get('+ mData +')"><i class="fa fa-eye"></i></button> <button class="btn btn-xs btn-default" title="Hapus" onclick="hapus('+mData+')"><i class="fas fa-trash"></i></button>';
                            }
            ...
            function get(id)
    {
        $.ajax({
            ...
            success:function(data){
                ...
                // $('#sampai_tanggal2').val(data.sampai_tanggal2);
                // $('#nama').val(data.nama_perwakilan);
    ...
    //             _data = $("#frmPengajuanEdit").serialize() + "& id_pengajuan="+id_pengajuan;
    //             _method = 'POST';
